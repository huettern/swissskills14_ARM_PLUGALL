...
#define LED_RED_ON() GPIO_SetBits(GPIOC, GPIO_Pin_12)
#define LED_RED_OFF() GPIO_ResetBits(GPIOC, GPIO_Pin_12)
#define LED_YEL_ON() GPIO_SetBits(GPIOD, GPIO_Pin_2)
#define LED_YEL_OFF() GPIO_ResetBits(GPIOD, GPIO_Pin_2)
